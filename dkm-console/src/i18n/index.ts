...
const en = {
    ...
    'layout.reset': 'Reset the panel sizes to their defaults',
    'layout.leftSeam': 'Drag to resize the stimulus list. Double-click to reset.',
    'layout.rightSeam': 'Drag to resize the inspector. Double-click to reset.',
    'layout.logSeam': 'Drag to resize the session log. Double-click to reset.',
    ...
    'dialog.startFromBody':
        'The run will begin at message {index}, {type}. Everything before it is marked skipped -- not sent -- and stays untouched and editable.',
    ...
    'row.sent': 'Sent',
    'row.skipped': 'Skipped',
    'row.skippedTitle': 'The run was told to start after this message, so it was passed over. It was never sent, and it is still editable.',
    'row.pending': 'Pending',
    'row.blocked': 'Blocked',
    ...
    'viz.layers.title': 'Displayed layers',
    'viz.layers.open': 'Layers',
    'viz.layers.openTitle': 'Choose which message types the plan view draws.',
    'viz.layers.body': 'The plan view draws one layer per message type. Switching a type off hides it here only — the message is still sent, still captured, still in the lists and still counted.',
    'viz.layers.hint': 'Hidden types keep their history: switching one back on brings back everything that arrived while it was off.',
    'viz.layers.count': '{shown} of {total} shown',
    'viz.layers.all': 'Show all',
    'viz.layers.none': 'Hide all',
    'viz.layers.done': 'Done',
...
const tr: Partial<Record<TranslationKey, string>> = {
    ...
    'layout.reset': 'Panel genişliklerini varsayılana döndür',
    'layout.leftSeam': 'Uyarım listesini yeniden boyutlandırmak için sürükleyin. Sıfırlamak için çift tıklayın.',
    'layout.rightSeam': 'Denetçiyi yeniden boyutlandırmak için sürükleyin. Sıfırlamak için çift tıklayın.',
    'layout.logSeam': 'Oturum kaydını yeniden boyutlandırmak için sürükleyin. Sıfırlamak için çift tıklayın.',
    ...
    'dialog.startFromBody':
        'Koşu {index}. mesajdan, {type}, başlayacak. Öncesindekiler atlandı olarak işaretlenir -- gönderilmiş sayılmaz -- ve düzenlenebilir kalır.',
    ...
    'row.sent': 'Gönderildi',
    'row.skipped': 'Atlandı',
    'row.skippedTitle': 'Koşu bu mesajdan sonra başlatıldığı için atlandı. Hiç gönderilmedi, hâlâ düzenlenebilir.',
    ...
    'viz.layers.title': 'Görüntülenen katmanlar',
    'viz.layers.open': 'Katmanlar',
    'viz.layers.openTitle': 'Plan görünümünde hangi mesaj türlerinin çizileceğini seçin.',
    'viz.layers.body': 'Plan görünümü her mesaj türü için bir katman çizer. Bir türü kapatmak yalnızca burada gizler — mesaj yine gönderilir, yine yakalanır, listelerde ve sayaçlarda yerini korur.',
    'viz.layers.hint': 'Gizli türler geçmişini korur: birini geri açtığınızda kapalıyken gelenler de görünür.',
    'viz.layers.count': '{total} türden {shown} tanesi görünür',
    'viz.layers.all': 'Hepsini göster',
    'viz.layers.none': 'Hepsini gizle',
    'viz.layers.done': 'Tamam',
